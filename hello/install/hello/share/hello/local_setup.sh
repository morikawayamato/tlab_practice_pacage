...
: ${AMENT_CURRENT_PREFIX:="/home/tmem-orin8/tlab_practice_pacage/hello/install/hello"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hello/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hello/environment/path.sh"
